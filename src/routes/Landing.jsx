          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24">
            <Card className="border-none bg-white/50 dark:bg-default-100/50 backdrop-blur-sm shadow-md hover:shadow-xl transition-all duration-300">
              <CardBody className="p-8 gap-4">
                ...
                <div>
                  ...
                  <p className="text-default-500 leading-relaxed">
                    Update scores in real-time with dedicated judge controls,
                    audit logs, and automatic leaderboard updates.
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card className="border-none bg-white/50 dark:bg-default-100/50 backdrop-blur-sm shadow-md hover:shadow-xl transition-all duration-300">
              <CardBody className="p-8 gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Brackets & Formats</h3>
                  <p className="text-default-500 leading-relaxed">
                    Flexible tournament structures. Single elimination, round
                    robin, and Swiss brackets fully supported.
                  </p>
                </div>
              </CardBody>
            </Card>
            ...
            <Card className="border-none bg-white/50 dark:bg-default-100/50 backdrop-blur-sm shadow-md hover:shadow-xl transition-all duration-300">
              <CardBody className="p-8 gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Audience Polls</h3>
                  <p className="text-default-500 leading-relaxed">
                    Engage the crowd. Collect live votes via QR codes or links
                    and award points to teams instantly.
                  </p>
                </div>
              </CardBody>
            </Card>
